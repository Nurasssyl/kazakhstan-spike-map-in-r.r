...
file_path <- "C:/Users/User/Desktop/R/kontur_population_KZ_20231101.gpkg"

# Load the GeoPackage file
population_data <- st_read(file_path)

### 2. LOAD DATA
### -------------
load_file_name <- gsub(".gz", "", file_path)
...
rayshader::render_highquality(
  filename = "kazakhstan_population_2022.png",
  preview = T,
  light = T,
  lightdirection = 225,
  lightaltitude = 60,
